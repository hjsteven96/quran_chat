...
const ChatWindow: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full max-w-3xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden border border-emerald-200">
      <div className="bg-gradient-to-r from-emerald-700 to-emerald-600 text-white p-5 text-center">
        <h1 className="text-2xl font-bold">Quran Knowledge Assistant</h1>
        <p className="text-sm mt-1 opacity-90">Ask about the wisdom and teachings of the Quran</p>
